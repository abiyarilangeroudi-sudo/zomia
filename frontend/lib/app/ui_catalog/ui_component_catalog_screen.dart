  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        SegmentedTabs(
          items: const ['All active items', 'Archived items with long label'],
          selectedIndex: 0,
          onChanged: (_) {},
        ),
        const SizedBox(height: 12),
      ...
      children: [
        ...
        const Wrap(
          ...
          children: [
            ...
            StatusBadge(label: 'Very long badge label'),
          ],
        ),
        SizedBox(height: 12),
  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        ProgressCard(
          title: 'Coffee Party With A Very Long Campaign Name',
          subtitle: 'Repeatable Clean Cafe With Long Business Name',
          value: 0.6,
        ...
        ProgressCard(
          ...
          timeRangeLabel: 'Jun 14, 2026 - Sep 14, 2026',
          badgeLabel: 'Very long limit reached',
          badgeTone: BadgeTone.success,
        ),
        SizedBox(height: 12),
        _ComponentName('RewardCard / customer'),
        RewardCard(
          title: 'Free Coffee Reward With Long Name',
          businessName: 'Zomia Cafe With A Very Long Business Name',
          subtitle: 'Gift reward with a longer display value',
        ...
        RewardCard(
          title: 'Free Coffee Reward With Long Name',
          subtitle: 'Use for loaded customer with long value',
          expiresLabel: 'Valid until 2026-07-12',
  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        MissionRow(
          title: 'Buy Coffee With A Very Long Mission Name',
          subtitle: '1 point each with long helper text',
          quantity: 2,
          onIncrement: _noop,
          onDecrement: _noop,
        ),
        ...
        Wrap(
          ...
          children: [
            MetricPill(
              ...
              label: '1 active reward with long label',
              color: BrandColors.purple,
            ),
            MetricPill(
              icon: Icons.flag_rounded,
              label: '2 campaigns with long label',
              color: BrandColors.teal,
            ),
            MetricPill(
              icon: Icons.history_rounded,
              label: '3 recent actions with long label',
        ...
        AppListRow(
          title: 'Zomia Cafe With A Very Long Business Name',
          subtitle: 'EUR · Europe/Berlin · Very long subtitle value',
